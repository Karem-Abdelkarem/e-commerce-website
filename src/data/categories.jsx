...
export const ITEMS = [
  {
    ...
    iconSrc: (
      ...
      >
        <g clipPath="url(#clip0_21882_868)">
          <path
        ...
        <defs>
          <clipPath id="clip0_21882_868">
            <rect width="56" height="56" fill="white" />
          </clipPath>
        </defs>
      </svg>
    ),
    title: "categoriesArray.0.title",
  },
  {
    id: idCounter++,
    iconSrc: (
      <svg
        ...
        xmlns="http://www.w3.org/2000/svg"
      >
        <g clipPath="url(#clip0_21882_613)">
          <path
        ...
        <defs>
          <clipPath id="clip0_21882_613">
            <rect width="56" height="56" fill="white" />
          </clipPath>
        </defs>
      </svg>
    ),
    title: "categoriesArray.1.title",
  },
  {
    id: idCounter++,
    iconSrc: (
      <svg
        ...
        xmlns="http://www.w3.org/2000/svg"
      >
        <g clipPath="url(#clip0_21882_621)">
          <path
        ...
        <defs>
          <clipPath id="clip0_21882_621">
            <rect width="56" height="56" fill="white" />
          </clipPath>
        </defs>
      </svg>
    ),
    title: "categoriesArray.2.title",
  },
  {
    id: idCounter++,
    iconSrc: (
      <svg
        ...
        xmlns="http://www.w3.org/2000/svg"
      >
        <g clipPath="url(#clip0_21882_1952)">
          <path
        ...
        <defs>
          <clipPath id="clip0_21882_1952">
            <rect width="56" height="56" fill="white" />
          </clipPath>
        </defs>
      </svg>
    ),
    title: "categoriesArray.3.title",
  },
  {
    id: idCounter++,
    iconSrc: (
      <svg
        ...
        xmlns="http://www.w3.org/2000/svg"
      >
        <g clipPath="url(#clip0_21882_1225)">
          <path
        ...
        <defs>
          <clipPath id="clip0_21882_1225">
            <rect width="56" height="56" fill="white" />
          </clipPath>
        </defs>
      </svg>
    ),
    title: "categoriesArray.4.title",
  },
  {
    id: idCounter++,
    iconSrc: (
      <svg
        ...
        xmlns="http://www.w3.org/2000/svg"
      >
        <g clipPath="url(#clip0_21882_3426)">
          <path
        ...
        <defs>
          <clipPath id="clip0_21882_3426">
            <rect width="56" height="56" fill="white" />
          </clipPath>
        </defs>
      </svg>
    ),
    title: "categoriesArray.5.title",
  },
  {
    id: idCounter++,
    iconSrc: (
      <svg
        className="fill-primary group-hover:fill-white size-14"
        width="64px"
        height="64px"
        viewBox="0 0 32 32"
        xmlns="http://www.w3.org/2000/svg"
    ...
    title: "categoriesArray.6.title",
  },
  {
    id: idCounter++,
    iconSrc: (
      <svg
        className="stroke-black group-hover:stroke-white size-14"
        width="64px"
        height="64px"
        viewBox="0 0 48 48"
        fill="none"
